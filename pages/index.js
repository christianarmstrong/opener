  ...
  return (
    <div className="w-fit h-fit overflow-auto max-w-[100%] max-h-[100%] bg-[#E46539]">
      ...
      <SignedOut>
        <picture>
          <source
            ...
            className=""
            srcSet="frontPagePhone.png"
          />
          <source
            media="(max-width: 1800px)"
            srcSet="openerHomeBackground.png"
          />
          <source media="(max-width: 400px)" srcSet="frontPagePhone.png" />
          <img
            src="openerDesktopBackground.png"
        ...
        <div className="w-fit h-fit" id="landingPageContainer">
          ...
          <a
            href="https://www.facebook.com/profile.php?id=100088076846318"
            target="_blank"
          >
            <img
              className="absolute right-0 w-16 h-12 invisible top-[37%] mr-5   lg:visible"
              alt="fb"
              src="facebook.png"
            />
          </a>
          ...
          <a href="https://twitter.com/Opener_app" target="_blank">
            <img
              className="absolute right-0 w-16 h-12 invisible  top-[25%] mr-5  lg:visible"
              alt=""
              src="twitter.png"
            />
          </a>
          ...
          <a href="https://www.instagram.com/opener_app/" target="_blank">
            <img
              className="absolute right-0  w-16 h-12 invisible top-[31%] mr-5  lg:visible"
              alt=""
              src="instagram.png"
            />
          </a>
          ...
          <h1
            className="relative leading-[4rem] lg:ml-[15rem] xl:ml-[20rem] 2xl:ml-[25rem] min-[1700px]:ml-[30rem] mt-[-.5em] md:mt-[1] lg:mt-6 min-[484px]:text-[5em] min-[484px]:leading-[.9em]
          ...
          <div
            className="relative text-white text-[1.6em] top-48 leading-10 mx-auto   w-3/4 sm:w-1/2 md:top-56 md:leading-[2.6rem]
          ...
          >
            From dating apps to DM’s. Type in their bio and get a personalized -
            proven to work opening line.
          </div>
          ...
          <a
            className="relative top-52 lg:w-80 lg:h-80  invisible lg:visible  md:mb-[-1em] lg:ml-20  "
            href="https://www.producthunt.com/posts/opener-2?utm_source=badge-top-post-topic-badge&utm_medium=badge&utm_souce=badge-opener&#0045;2"
            target="_blank"
          >
            <img
              src="https://api.producthunt.com/widgets/embed-image/v1/top-post-topic-badge.svg?post_id=371804&theme=light&period=weekly&topic_id=268"
              className="w-64 h-40 lg:w-80 lg:h-80 top-52 lg:ml-20"
            />
          </a>

          <img
            className="relative w-[15rem] h-[7.5rem] ml-[45%] lg:ml-[75%] top-28 sm:top-28 md:top-40 lg:top-1 md:w-[20rem]  md:h-[10rem] xl:w-90 xl:h-30 "
            src="arrow.png"
          />
          <h3 className="relative bottom-4 text-center right-0 top-10 sm:top-10 left-[-3rem] md:left-[-4.5rem] md:top-20 lg:top-[-5rem] ml-[2%] lg:ml-[60%] text-white text-4xl md:text-5xl lg:text-5xl ">
            Learn More
          </h3>
          <div className="">
            <img
            ...
            <p className="relative lg:top-[14rem] w-3/4 top-[10rem] md:top-[22rem] lg:w-7/12 mt-5 mx-auto text-center manrope text-white text-xl">
              At Opener, we want everybody to have an equal opportunity to start
              a conversation with someone they're interested in. That's why we
              are working to make it as easy as possible.
            </p>
            ...
            <div className="relative top-[12rem] md:top-[22rem] lg:top-[17rem] lg:flex lg:justify-items-center ">
              ...
              <div className=" lg:basis-2/6 ">
                ...
                <p className=" text-white text-center  mt-5 w-3/4 lg:w-4/5  manrope mx-auto text-xl">
                  We take your person of interests bio and create the perfect
                  opening line. Whether you need an opening line for a first DM
                  or a conversation with a stranger on a dating app, Opener has
                  got you covered.
                </p>
              </div>
              ...
              <div className="lg:basis-2/6">
                ...
                <p className=" text-white text-center mt-5 w-3/4 lg:w-4/5 manrope mx-auto  text-xl">
                  We make it easy to get started – just set up your profile and
                  let us do the rest. So what are you waiting for? Give Opener a
                  try today and see how easy it can be to start a conversation
                </p>
              </div>
              <div className=" lg:basis-1/6 " />
            </div>
            ...
            <video
              className="relative w-[20rem] h-[10rem] sm:w-[30rem] sm:h-[15rem] md:w-[40rem] md:h-[20rem] lg:w-[60rem] lg:h-[30rem] xl:w-[70rem] xl:h-[35rem] mx-auto  top-[22rem] md:top-[28rem] lg:top-[27rem]"
              muted
              autoPlay
              loop
              controls
      ...
      <SignedIn>
        ...
        >
          <div className="fixed inset-0 overflow-y-auto bg-black/50">
            <div className="fixed inset-0 overflow-y-auto">
              <Dialog.Panel
                className="w-full relative mx-auto top-[25%] max-w-md transform overflow-hidden rounded-2xl bg-[#cd5536]  border-[1.75px]
                            border-[#DA9C93] rounded-[30px] shadow-black/25 shadow-md  text-white p-6 text-left align-middle transition-all"
              >
                <Dialog.Title className="text-2xl text-center font-medium leading-8 text-white mb-2 ">
                  Looks like you’re out of Openers. Choose your paid plan!
                </Dialog.Title>
                <form
                  className="flex"
                ...
                >
                  ...
                  >
                    <img
                      src="chooseYourPlan.png"
                      className="h-18 w-72 m-auto mt-4 mb-2"
                ...
                <a className=" text-white shadow-black/25" href="">
                  <img src="bigPopupLine.png" className="" alt="Big Line" />
                </a>
                <p className="text-2xl text-center mb-3 ">
                  Get 10 more Openers free by sharing us to any of these social
                  apps or leaving a review!
                </p>
                <a className=" text-white shadow-black/25" href="">
                  <img
                    src="littlePopupLine.png"
                    className=""
                    alt="Little Line"
                  />
                </a>
        ...
        <div
          className="fixed top-[10%] sm:top-[15%] md:top-[15%] left-1/2 transform -translate-x-1/2 text-white text-[5rem] sm:text-[4.5em] md:text-[5rem] lg:text-[6rem]"
          id="openerHeadingBefore"
        >
        ...
        <div
          className="fixed top-[35%] sm:top-[32%] md:top-[32%] left-1/2 transform -translate-x-1/2 invisible"
          id="outputBoxWhole"
        >
          <div className="" id="Try Again">
            ...
            >
              <div className="text-white " id="retryText">
                <img
                  src="genButtonNoText.png"
                  alt=""
                  className="h-10 w-32 md:h-16 md:w-40 mx-auto absolute right-0 bottom-0 mb-5 mr-5"
                />
                <p className="absolute right-0 bottom-0 mb-6 mr-8 md:mb-9 md:mr-12 text-2xl">
                  Try Again
                </p>
              </div>
            </a>
          ...
          <a href="https://badoo.com/" target="_blank">
            <img
              className="absolute bottom-6 left-[1rem] h-7 w-9 sm:left-5 sm:w-10 sm:h-8"
              alt="fb"
              src="badoo.png"
            />
          </a>
          <a href="https://bumble.com/" target="_blank">
            <img
              className="absolute bottom-0 left-[2.5rem] h-8 w-10 sm:left-[3.1rem] sm:w-11 sm:h-9 mb-[1.15rem] "
              alt=""
              src="bumble.png"
            />
          </a>
          <a href="https://tinder.com/" target="_blank">
            <img
              className="absolute bottom-0 left-[4.8rem] mb-[1.27rem] h-7 w-8 sm:left-[5.8rem] sm:w-9 sm:h-8 sm:mb-[1.4rem] "
              alt=""
              src="tinder.png"
            />
          </a>
          <a
            onClick={() => navigator.clipboard.writeText(apiOutput)}
            target="_blank"
          >
            <img
              className="absolute bottom-0 left-[6.4rem] h-8 w-12 sm:left-[7.8rem] sm:w-14 sm:h-10 mb-[1.15rem] "
              alt=""
              src="copy.png"
            />
          </a>
        ...
        <div
          className="fixed w-screen h-fit mr-24 left-[0%] top-[25%] sm:top-[27%]"
          id="prompts"
        >
          <div
            className="lg:flex lg:flex-wrap lg:w-screen lg:align-middle lg:justify-between content-center"
            id="nameGroup"
          >
            <div className="relative flex-auto mt-12 lg:w-auto" id="bioGroup">
              <div
                className="text-white mb-4 text-center text-[2.5rem] lg:ml-[0] ml-[0] text-2xl mt-14 lg:mt-12  "
                id="enterDescriptionText"
              >
          ...
          <div className=" w-screen h-screen" id="enterGenerateButton">
            ...
            >
              <img
                src="genButton.png"
                className="h-22 w-48 lg:h-24 lg:w-60 mt-8 mx-auto "
                alt="Generate Opener"
              />
            </a>
          </div>
        ...
        <div className="invisible lg:visible">
          <div className="fixed left-4 bottom-4 text-white text-lg text-opacity-75">
            Made with 🧡 by Cheyenna & Christian Armstrong. Check our{" "}
            <a
              className="underline underline-offset-2"
              href="https://www.termsofusegenerator.net/live.php?token=JxycYwSYZJzn3E5cDHs0SZh9RAEWWtXb"
            >
              terms of use.
            </a>{" "}
          </div>
          <div className="fixed right-32 bottom-3 text-white text-lg text-opacity-75 ">
            {" "}
            <a
              href={`mailto:customerSupport@opener.chat?subject=Inquiry&body=Hi, I have a question about your product.`}
            >
              Customersupport@opener.chat
            </a>
          </div>
          <a
